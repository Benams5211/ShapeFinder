...
class FigureSkateModifier {
  ...
  apply(shape) {
    // Let one modifier instance (the first shape) drive director updates & starts
    if (shape === interactors[0]) {
    ...
    if (active && target) {
    // find any TeleportModifier on this shape and mark disabled
