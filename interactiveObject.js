...
function spawnInteractors() {
  ...
  function makeStaticWantedFrom(o) {
    ...
    if (o instanceof ClickCircle) {
      return new ClickCircle(width/2-o.r, 90-o.r, o.r, o.fillCol, baseOpts);
    } else if (o instanceof ClickRect) {
      return new ClickRect(width/2-o.w/2, 80-o.h/2, o.w, o.h, o.fillCol, o.radius || 0, baseOpts);
    } else if (o instanceof ClickTri) {
      return new ClickTri(width/2-20, 60, o.size, o.fillCol, { ...baseOpts, angle:0 });
    }
    return null;
  }
