...
function preload() {
  ...
  } else if (typeof loadSound === "function") {
    try { sfxCorrect = loadSound("assets/correct.mp3"); } catch (e) { console.warn("Failed to preload correct.mp3"); }
    try { sfxIncorrect = loadSound("assets/incorrect.mp3"); } catch (e) { console.warn("Failed to preload incorrect.mp3"); }
    try { sfxMenu = loadSound("assets/menuSelect.mp3"); } catch (e) { console.warn("Failed to preload menuSelect.mp3"); }
    try { bgmHard = loadSound("assets/gameBGM.mp3"); } catch (e) { console.warn("Failed to preload gameBGM.mp3"); }
  }
}
...
function mouseInside(btn) {
  if (!btn) return false; // prevents "undefined" errors
